...
public class RestaurantController {
  ...
  public ResponseEntity<GetRestaurantsResponse> getRestaurants(
    ...
    List<Restaurant> restaurants = new ArrayList<Restaurant>();  
      ...
      && getRestaurantsRequest.getLongitude() >= -180 && getRestaurantsRequest.getLongitude() <= 180   && getRestaurantsRequest.getSearchFor() == null)
      ...
      getRestaurantsResponse = restaurantService
          ...
          // System.out.print(getRestaurantsResponse);
          ...
          for (int i = 0; i < restaurants.size(); i++) {
            ...
            restaurants.get(i).setName(changeToAscii(restaurants.get(i).getName()));
            // System.out.println(restaurants.get(i).getName());
  ...
  private String changeToAscii(String str) {
    if (str != null) {
